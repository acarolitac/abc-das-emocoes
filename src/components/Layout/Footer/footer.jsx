    ...
    <footer className="footer bg-base-200 text-base-content">
      <div className="footer-container">
        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <nav className="footer-nav">
              ...
              <a href="/#sobre" className="footer-link">o que é ABC</a>
              <a href="/materiais" className="footer-link">Nossos Materiais</a>
          ...
          <div className="footer-section">
            ...
            <div className="footer-contact">
              <p className="footer-contact-item">
                ...
                <a href="mailto:atendimento@abcdasemocoes.com.br" className="footer-contact-link">
                  atendimento@abcdasemocoes.com.br
                </a>
              </p>
            </div>
          </div>
          ...
          <div className="footer-section">
            ...
            <div className="footer-social">
             ...
             <div className="footer-social-icons">
                {/* WhatsApp */}
                <a
                  href="https://wa.me/5561999453755"
                  target="_blank"
                ...
                {/* Instagram */}
                <a 
                  href="https://www.instagram.com/abcdasemocoes/" 
                  target="_blank" 
                  rel="noopener noreferrer"
        ...
        <div className="footer-copyright">
          <p>ABC das Emoções &copy; {currentYear} </p>
        </div>
      </div>
    </footer>
  );
